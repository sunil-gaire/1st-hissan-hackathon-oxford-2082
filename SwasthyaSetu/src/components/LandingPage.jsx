...
import { Stethoscope, Ambulance, Brain, Apple, Book,ChevronDown, ChevronUp,Facebook, Twitter, Instagram, Linkedin  } from "lucide-react";
...
const faqData = [
  ...
  {services.map((service) => {
    ...
    return (
      <div key={service.id} className="bg-white hover:scale-105 p-6 rounded-xl shadow hover:shadow-lg transition flex flex-col items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 ">
        <div className="space-y-2">
          ...
          <p className="text-gray-400 text-sm">
            Connecting people to healthcare and awareness, anytime, anywhere.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400 text-sm">Email: support@swasthyasetu.com</p>
          ...
          <div className="flex space-x-3 mt-2">
            ...
            <a href="#" className="hover:text-teal-400"><Linkedin className="w-5 h-5"/></a>
          </div>
        </div>
      </div>
